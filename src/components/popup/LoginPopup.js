  ...
  return (
    <>
      {!currentUser ?
        ...
        <PopupWithForm onSubmit={onSignOut} isValid={true} handleSwitchPopup={handleSwitchPopup} linkText='Add a card' name="login" title="Sign in" isOpen={isOpen} onClose={onClose} buttonText='I know, sign out anyway.'>
