...
export function ButtonFollow({ onClick }) {
    return (
        <>
            <div className="main">
                <div className="up">
                    <button className="card1" onClick={onClick.instagram}>
                    ...
                    <button className="card2" onClick={onClick.twitter}>
                ...
                <div className="down">
                    <button className="card3" onClick={onClick.github}>
                    ...
                    <button className="card4" onClick={onClick.linkedin}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" width="30px" height="30px" className="linkedin">
...
export function ButtonHamburger({ onClick, theme }) {
    return (
        <>
            <label className="button-hamburger" onChange={onClick}>
                <input className="button-hamburger_input" type="checkbox" />
                <svg viewBox="0 0 32 32">
            ...
            {todoList.map((item, index) => {
                return (
                    <div class="checkbox-wrapper">
                        <input value="2" name={`checkbox-${index}`} type="checkbox" id="02-11" />
                        <label>{item}</label>
                    </div>
                );
            })}
